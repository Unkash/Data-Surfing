...
public class UpdateChecker {
    ...
    private static void startDownload(Activity activity, String version, String apkUrl) {
        ...
        Button btnInstall = progressView.findViewById(R.id.btnInstall);
        ...
        // Borrar descarga previa si existe
        ...
        // Polling cada 500ms para actualizar progreso Y detectar fin
            ...
            @Override public void run() {
                ...
                if (cursor.moveToFirst()) {
                    ...
                    if (status == DownloadManager.STATUS_SUCCESSFUL) {
                        // Descarga completada — mostrar botón instalar
                        progressBar.setProgress(100);
                        tvStatus.setText("✅ Descarga completa");
                        btnInstall.setVisibility(View.VISIBLE);
                        btnInstall.setOnClickListener(v -> {
                            progressDialog.dismiss();
                            installApk(activity, fileName);
                        });
                        // Auto-instalar tras 1 segundo
                        handler.postDelayed(() -> {
    ...
    private static void installApk(Activity activity, String fileName) {
        try {
            ...
            if (!apkFile.exists()) {
                Log.e(TAG, "APK no encontrado: " + apkFile.getAbsolutePath());
                return;
            }
