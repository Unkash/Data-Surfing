...
public class SpotAlertActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Mostrar hint con el offshore preconfigurado para este spot
        String offshoreHint = String.format(
            "💡 Offshore preconfigurado para %s: %d°-%d° (%s-%s). " +
            "Puedes ajustarlo si conoces mejor el spot.",
            spot.name,
            spot.offshoreWindMin, spot.offshoreWindMax,
            es.unkash.surfmalaga.data.SurfData.directionToText(spot.offshoreWindMin),
            es.unkash.surfmalaga.data.SurfData.directionToText(spot.offshoreWindMax)
        );
        binding.tvOffshoreHint.setText(offshoreHint);
    }
