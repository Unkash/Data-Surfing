...
public class SurfSpot {
    ...
    /**
     * Nombre exacto de la playa en el webservice del Ayuntamiento de Málaga.
     * null si no está cubierta (municipios fuera de Málaga capital).
     */
    public String nombreAyuntamiento;

    // Estado de bandera (se rellena al cargar)
    public BanderaRepository.Bandera bandera = BanderaRepository.Bandera.SIN_DATOS;
    public String banderaHora = null;
    ...
    public SurfSpot(String id, String name, double lat, double lon,
                    ...
                    String webcamUrl, String nombreAyuntamiento) {
        this.id = id;
        this.name = name;
        this.lat = lat;
        this.lon = lon;
