...
public class SpotRepository {
    ...
    private void initSpots() {
        ...
        // id, nombre, lat, lon, offshoreMin, offshoreMax, swellMin, swellMax, webcam, anchorHtml
        spots.add(new SurfSpot("misericordia","La Misericordia",      36.6912, -4.4406, 290, 340, 100, 160, "https://meteo365.es/livecams/malaga.php",            "LaMisericordia"));
        spots.add(new SurfSpot("guadalmar",   "Guadalmar",           36.6627, -4.4579, 290, 340, 100, 160, "https://es.surf-forecast.com/breaks/Guadalmar/webcams/latest", "CampodeGolf-SanJulian"));
        ...
        spots.add(new SurfSpot("malagueta",   "La Malagueta",        36.7164, -4.4083, 310, 360, 100, 160, "https://meteo365.es/livecams/malaga.php",            "LaMalagueta"));
        spots.add(new SurfSpot("chanquete",   "El Chanquete / Dedo", 36.7169, -4.3499,  10,  50, 100, 160, null,                                                "ElDedo"));
        spots.add(new SurfSpot("larana",      "La Araña",            36.7127, -4.3242,  10,  50, 100, 160, null,                                                "LaArana"));
