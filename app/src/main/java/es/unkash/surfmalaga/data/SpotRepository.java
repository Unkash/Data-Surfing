...
public class SpotRepository {
    ...
    private void initSpots() {
        ...
        // id, nombre, lat, lon, offshoreMin, offshoreMax, swellMin, swellMax, webcam, nombreWS
        ...
        spots.add(new SurfSpot("guadalmar",   "Guadalmar",           36.6627, -4.4579, 290, 340, 100, 160, "https://es.surf-forecast.com/breaks/Guadalmar/webcams/latest", "Campo de Golf - San Julian"));
        ...
        spots.add(new SurfSpot("larana",      "La Araña",            36.7127, -4.3242,  10,  50, 100, 160, null,                                                "La Arana"));
