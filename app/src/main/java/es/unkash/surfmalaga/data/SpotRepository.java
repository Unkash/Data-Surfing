...
public class SpotRepository {
    ...
    private void initSpots() {
        ...
        spots.add(new SurfSpot("guadalmar",   "Guadalmar",          36.670, -4.490, 290, 340, 100, 160));
        spots.add(new SurfSpot("losalamos",   "Los Álamos",         36.672, -4.478, 290, 340, 100, 160));
        spots.add(new SurfSpot("malapesquera","Malapesquera",       36.617, -4.527, 290, 340, 100, 160));
        spots.add(new SurfSpot("carihuela",   "La Carihuela",       36.618, -4.530, 290, 340, 100, 160));
        spots.add(new SurfSpot("sunset",      "Sunset / Bil-Bil",   36.597, -4.508, 290, 340, 100, 160));
        spots.add(new SurfSpot("elchino",     "El Chino (Fuengirola)",36.538,-4.619,340,  20, 100, 160));
        spots.add(new SurfSpot("calaburras",  "Faro Calaburras",    36.507, -4.638, 340,  20, 120, 180));
        spots.add(new SurfSpot("cabopino",    "Cabopino",           36.484, -4.743, 340,  20, 100, 140));
        spots.add(new SurfSpot("malagueta",   "La Malagueta",       36.714, -4.412, 310, 360, 100, 160));
        spots.add(new SurfSpot("chanquete",   "El Chanquete / Dedo",36.714, -4.395, 310, 360, 100, 160));
        spots.add(new SurfSpot("larana",      "La Araña",           36.730, -4.330, 310, 360, 100, 160));
        spots.add(new SurfSpot("benajarafe",  "Benajarafe",         36.718, -4.196, 310, 360, 120, 180));
        spots.add(new SurfSpot("lagos",       "Lagos / Pijil",      36.742, -4.002, 310, 360, 120, 180));
    }
