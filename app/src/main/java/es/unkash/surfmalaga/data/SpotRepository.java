...
public class SpotRepository {
    ...
    private void initSpots() {
        ...
        spots.add(new SurfSpot("misericordia","La Misericordia",      36.6912, -4.4406, 290, 340, 100, 160, "https://meteo365.es/livecams/malaga.php"));
        spots.add(new SurfSpot("guadalmar",   "Guadalmar",           36.6627, -4.4579, 290, 340, 100, 160, "https://es.surf-forecast.com/breaks/Guadalmar/webcams/latest"));
        spots.add(new SurfSpot("losalamos",   "Los Álamos",          36.6375, -4.4833, 290, 340, 100, 160, null));
        spots.add(new SurfSpot("malapesquera","Malapesquera",        36.5953, -4.5188, 290, 340, 100, 160, null));
        spots.add(new SurfSpot("carihuela",   "La Carihuela",        36.6072, -4.5049, 290, 340, 100, 160, null));
        spots.add(new SurfSpot("sunset",      "Sunset / Bil-Bil",    36.5903, -4.5273, 290, 340, 100, 160, "https://meteo365.es/livecams/benalmadena.php"));
        spots.add(new SurfSpot("elchino",     "El Chino (Fuengirola)",36.5375,-4.6190, 280, 320, 100, 160, "https://meteo365.es/livecams/fuengirola-puerto.php"));
        spots.add(new SurfSpot("calaburras",  "Faro Calaburras",     36.5074, -4.6405, 300, 340, 120, 180, null));
        spots.add(new SurfSpot("cabopino",    "Cabopino",            36.4840, -4.7430, 350,  30, 100, 140, null));
        spots.add(new SurfSpot("malagueta",   "La Malagueta",        36.7164, -4.4083, 310, 360, 100, 160, "https://meteo365.es/livecams/malaga.php"));
        spots.add(new SurfSpot("chanquete",   "El Chanquete / Dedo", 36.7169, -4.3499,  10,  50, 100, 160, null));
        spots.add(new SurfSpot("larana",      "La Araña",            36.7127, -4.3242,  10,  50, 100, 160, null));
        spots.add(new SurfSpot("benajarafe",  "Benajarafe",          36.7180, -4.1960, 330,  30, 120, 200, null));
        spots.add(new SurfSpot("lagos",       "Lagos / Pijil",       36.7420, -4.0020, 330,  30, 120, 200, null));
    }
